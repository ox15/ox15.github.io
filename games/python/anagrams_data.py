...
def loadWords():
    ...
    try:
        if words==1:
            ...
            print("Invalid command. Using the list of other words.")
            WORDLIST_FILENAME = "words.txt"
    except:
        print("There was an error choosing a list.")
    ...
    for letter in word:
        try:
            ...
            if handCopy[letter] < 0:
                #print(letter,'not enough in hand')
                return False
        except KeyError:
...
def playGame(wordList):
    ...
    while True:
        # Get user command about hand or exit
